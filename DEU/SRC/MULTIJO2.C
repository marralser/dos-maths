...
int main() {
    ...
    clrscr();
    textcolor(YELLOW);
    cprintf("Willkommen zum Multiplizieren - Quiz !\n");
	...
	num2 = (rand() % (10 - 3 + 1)) + 3;
	num3 = num1 * num2;
	printf("\n\nRunde %d.\n\nWas ergibt %d mal %d? ", round, num1, num2);
	round = round + 1;
	scanf("%d", &answer);
    ...
    printf ("\n");
    cprintf("Danke fuers öben.");
    printf("\n");
    cprintf("Du hast %d Runden gespielt, und davon %d Punkte gesammelt.\n Bis bald! \n", round -1, score);
